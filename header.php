...
<div id="page" class="site">
	<a class="skip-link screen-reader-text" href="#content"><?php esc_html_e( 'Skip to content', 'doly-plus' ); ?></a>
			...
			<div class="row">
				...
				<div class="col-lg-8">
					<div class="search-form text-right">
						...
						<button class="screen-reader-text menu-close"><?php esc_html_e( 'Close Menu', 'doly-plus' ); ?></button>
						<div class="mainmenu">
							<?php
								wp_nav_menu( array(
